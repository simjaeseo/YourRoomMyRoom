        ...
        <div className="container">
          <nav className="container_inner flex">
            ...
            <div className="navButton flex">
              ...
              <TemporaryDrawer />
              <React.Fragment className="navButton_profile">
                <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                  <Tooltip title="내 정보">
                    ...
                    >
                      <Avatar sx={{ width: 48, height: 48, backgroundColor: "#2C4B48", fontSize: 30, fontFamily: "SeoulHangangB" }}>닉</Avatar>
                ...
                >
                  ...
                  <MenuItem sx={{ color: "#2C4B48", fontSize: 32, fontFamily: "SeoulHangangB" }} onClick={clickProfile}>
                    <FaceIcon />
                    &nbsp;내 프로필
                  </MenuItem>
                  <MenuItem sx={{ color: "#2C4B48", fontSize: 32, fontFamily: "SeoulHangangB" }}>
                    <HomeIcon />
                    &nbsp;내 양도글
                  </MenuItem>
                  <MenuItem sx={{ color: "#2C4B48", fontSize: 32, fontFamily: "SeoulHangangB" }}>
                  ...
                  <Divider />
                  <MenuItem sx={{ color: "#2C4B48", fontSize: 32, fontFamily: "SeoulHangangB" }} onClick={clickLogout}>
                    {/* <ListItemIcon> */}
                    <Logout />
                    {/* </ListItemIcon> */}
                    &nbsp;로그아웃
